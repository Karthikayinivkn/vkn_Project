...
<body>
	<div class="container">
		<form class="form" action="Login.jsp">
			...
			<br/>
			<input class="form-control btn btn-lg btn-primary" type="submit" value="Login"></br>
			<br/>
			<input type="button" name="forgot password" onclick="window.location.href='Forgot1.jsp'" value="forgot password?">
			</form>
			<form action="Signup.jsp">
			<button class="btn" style="float:right" href="WebContent/Signup.jsp">Signup</button>
		</form>		
	</div>
</body>
</html>